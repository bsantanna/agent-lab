...
class TestIntegrationsEndpoints:
    ...
    async def test_create_and_get_by_id_success(self, client):
        ...
        # when
        response_2 = client.get(f"/integrations/{integration_id}")
    ...
    async def test_create_and_delete_success(self, client):
        ...
        # when
        response_2 = client.delete(f"/integrations/delete/{integration_id}")
    ...
    async def test_delete_not_found(self, client):
        ...
        # when
        response = client.delete(f"/integrations/delete/{integration_id}")
