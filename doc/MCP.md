...
Another example, asking Claude Desktop to show a code snippet generated by the [supervised coder agent](/notebooks/05_test_agent_type-multiagent-coder.ipynb) in a previous interaction:
