# {{ cookiecutter.project_slug }}-dev Plugin

A comprehensive, structured workflow for feature development with specialized agents for codebase exploration, architecture design, and quality review.

## Overview

The `{{ cookiecutter.project_slug }}-dev` plugin provides a systematic 7-phase approach to building new features. Instead of jumping straight into code, it guides you through understanding the codebase, asking clarifying questions, designing architecture, and ensuring quality—resulting in better-designed features that integrate seamlessly with your existing code.
...
This plugin embeds these practices into a structured workflow that runs automatically when you use the `/{{ cookiecutter.project_slug }}-dev` command.

## Command: `/{{ cookiecutter.project_slug }}-dev`

Launches a guided feature development workflow with 7 distinct phases.

**Usage:**
```bash
/{{ cookiecutter.project_slug }}-dev Add user authentication with OAuth
```
...
**Example:**
```
You: /{{ cookiecutter.project_slug }}-dev Add caching
...
```bash
/{{ cookiecutter.project_slug }}-dev Add rate limiting to API endpoints
```
