...
class McpRegistrar:
    ...
    def instructions_fragment(self) -> str | None:
        """Override to contribute a paragraph to the server's instructions."""
        return None  # intentionally empty — subclasses override as needed
